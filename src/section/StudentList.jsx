        ...
        <div className="max-w-[848px] mx-auto overflow-auto">
          <table className="w-full">
            ...
            <tbody>
              ...
              {Student.filter((t) => t.class == 1)?.map((std, i) => (
                <tr className="border-b border-[#7ECEB529]" key={i}>
                  <td className="p-5 text-sm md:text-xl">{std.id}</td>
                  <td className="p-5 text-sm md:text-xl">
                    <div className="flex space-x-3 items-center">
                      <img
                        ...
                        alt=""
                      />
                      <span className="whitespace-nowrap">{std.name}</span>
                    </div>
                  </td>
              ...
              {Student.filter((t) => t.class == 2)?.map((std, i) => (
                <tr className="border-b border-[#7ECEB529]" key={i}>
                  <td className="p-5 text-sm md:text-xl">{std.id}</td>
                  <td className="p-5 text-sm md:text-xl">
                    <div className="flex space-x-3 items-center">
